...
//             <div className="bg-gradient-to-r from-green-400 to-emerald-500 rounded-full p-3 mr-4 shadow-lg flex-shrink-0">
//               <svg
...
//               className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white px-4 py-3 rounded-lg transition-all duration-300 font-medium shadow-lg hover:shadow-xl transform hover:scale-105"
...
//                   className="w-full px-3 py-2.5 border-2 border-green-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 text-sm"
//                   disabled={loading}
//                   onKeyPress={(e) => e.key === "Enter" && handleApplyCoupon()}
//                 />
//               </div>

//               {/* Buttons - Stack vertically to ensure they fit */}
//               <div className="flex flex-col gap-2 w-full">
//                 <button
//                   onClick={handleApplyCoupon}
//                   disabled={loading || !couponCode.trim()}
//                   className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 disabled:from-gray-400 disabled:to-gray-500 text-white px-4 py-2.5 rounded-lg transition-all duration-300 font-medium shadow-lg hover:shadow-xl transform hover:scale-105 disabled:transform-none text-sm"
//                 >
...
//                     setCouponCode("");
//                   }}
//                   className="w-full bg-gray-500 hover:bg-gray-600 text-white px-4 py-2.5 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl text-sm"
//                   disabled={loading}
//                 >
//                   Cancel
//                 </button>
...
//                   className="font-mono bg-white border border-gray-300 hover:border-green-400 px-2 py-1 rounded text-xs transition-all duration-200 hover:shadow-md"
//                 >
//                   {code}
//                 </button>
//               ))}
...
//                 <p className="text-green-700 font-medium text-sm">
//                   Coupon{" "}
//                   <span className="font-mono bg-green-100 px-2 py-1 rounded border border-green-300 text-xs">
//                     {appliedCouponCode}
//                   </span>{" "}
...
//       {error && (
//         <div className="mt-3 p-3 bg-red-100 border border-red-300 rounded-lg text-red-700 text-xs">
//           {error}
//         </div>
//       )}

//       {!isOnline && (
//         <div className="mt-3 p-3 bg-yellow-100 border border-yellow-300 rounded-lg text-yellow-700 text-xs">
